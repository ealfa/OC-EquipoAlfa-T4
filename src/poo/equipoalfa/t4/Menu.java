...
public class Menu extends JFrame implements ActionListener {
    ...
    JButton cmdClientesB, cmdMovimientosB;
    ...
    public Menu(){
        ...
        cmdClientesB = new JButton("Clientes");
        cmdMovimientosB = new JButton("Movimientos");
        ...
        cmdClientesB.addActionListener(this);
        cmdMovimientosB.addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (e.getSource() == cmdClientesB) {
            JOptionPane.showMessageDialog(null, "Presionaste Clientes");
            Clientes clientes = new Clientes();
        } else if (e.getSource() == cmdMovimientosB) {
...
/*public class Menu extends JFrame implements ActionListener {
    JMenuItem cmdAbrir, cmdCerrar, cmdSalir,cmdCopiar,cmdPegar;
    JButton cmdCancelar, cmdClientesB, cmdMovimientosB;
    JMenu menuArchivo, menuEdicion;
    JMenuBar braMenu;
